...
![64 Modules](https://img.shields.io/badge/Modules-64-success)
...
| **Food Ordering (GloriaFood + WPPizza)** |  ➡️  | POS Restaurant                   |  ❌  | Food orders → pos.order with line items, per-plugin extraction, partner resolution                                                     |
